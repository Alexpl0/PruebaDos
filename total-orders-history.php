...
<body>
    ...
    <main class="container-fluid">
        ...
        <!-- Filtro total resumen -->
        <div class="row mb-4">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h6 class="mb-0">
                            <i class="fas fa-filter me-2"></i>Total Filters
                            <button class="btn btn-sm btn-outline-secondary float-end" id="toggleTotalFilters">
                                <i class="fas fa-chevron-down"></i>
                            </button>
                        </h6>
                    </div>
                    <div class="card-body" id="totalFilterPanelBody" style="display: none;">
                        <div class="row g-3">
                            <div class="col-md-3">
                                <label for="totalFilterDateRange" class="form-label">Date Range</label>
                                <select class="form-select" id="totalFilterDateRange">
                            ...
                            <div class="col-md-3">
                                <label for="totalFilterStatus" class="form-label">Status</label>
                                <select class="form-select" id="totalFilterStatus">
                            ...
                            <div class="col-md-3">
                                <label for="totalFilterApprovalStatus" class="form-label">Approval Status</label>
                                <select class="form-select" id="totalFilterApprovalStatus">
                            ...
                            <div class="col-md-3">
                                <label for="totalFilterCostRange" class="form-label">Cost Range (€)</label>
                                <select class="form-select" id="totalFilterCostRange">
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <button class="btn btn-primary btn-sm me-2" id="applyTotalFilters">
                                    <i class="fas fa-check"></i> Apply Filters
                                </button>
                                <button class="btn btn-outline-secondary btn-sm" id="clearTotalFilters">
