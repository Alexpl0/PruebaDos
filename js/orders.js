...
document.addEventListener('DOMContentLoaded', function () {
    ...
    createCards = function(orders) {
        ...
        orders.forEach(order => {
            ...
            card.style.position = "relative"; // Add position relative for the notification badge
            ...
            if (statusName === "aprobado") card.style.backgroundColor = "#449843"; // Verde claro
            ...
            // HTML structure of the card with conditional notification badge
        ...
        // Initialize tooltips for the notification badges
