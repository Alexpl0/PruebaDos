...
function renderAreaDistributionChart() {
    console.log("[DEBUG] renderAreaDistributionChart:", filteredData.length, filteredData.slice(0, 2));
    // Procesar datos
    const areaData = {};
...
function renderPaidByChart() {
    console.log("[DEBUG] renderPaidByChart:", filteredData.length, filteredData.slice(0, 2));
    // Procesar datos
    const paidByData = {};
