 ...
 * 5. CORREGIDO: Se añade un bloque try-catch para evitar que errores silenciosos detengan otros scripts.
...
(function() {
    ...
    function initializeReferenceSelector() {
        ...
        // ======================= INICIO DE LA MODIFICACIÓN Y CORRECCIÓN =======================
        // Este evento se dispara cuando el usuario selecciona una opción.
        $referenceOrder.on('select2:select', function(e) {
            // Se envuelve la lógica en un try...catch para máxima seguridad.
            // Esto previene que un error aquí detenga la ejecución de otros scripts (como el de los botones de divisa).
            try {
                ...
                if (data && !data.isNew) {
                    ...
                    setTimeout(() => {
                        ...
                        // Comprobación defensiva para asegurar que la instancia de select2 existe
        ...
        // ======================== FIN DE LA MODIFICACIÓN Y CORRECCIÓN =========================
    }
